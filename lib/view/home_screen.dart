...
class HomePage extends GetView<TaskController> {
 ...
 final homeController = Get.put(TaskController());
  ...
  Widget searchField(){
    return  Obx(
          ...
          child: CupertinoSearchTextField(
            ...
            onChanged: (value){
              if(homeController.searchController.value.text.isNotEmpty){
                homeController.searchTasksByTitle(value);
              }
              else{
                homeController.taskData.value = [];
                homeController.getAllTask();
                homeController.filteredSet = homeController.taskData;
               ...
               child: Card(
                   ...
                   child: ListTile(
                     ...
                     subtitle: Column(
                       ...
                       children: <Widget>[
                         Text(
                           homeController.taskData[position].description,maxLines: 3,
                           style: const TextStyle(
                               fontSize: 16.0,
